...
<body class="bg-gray-50 text-gray-800">
    ...
    <main>
        ...
        <section id="feedback" class="pt-12 bg-gray-50">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
...
<footer class="bg-gray-800" aria-labelledby="footer-heading">
  ...
  <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:flex-col md:items-center md:justify-center space-y-6">
      ...
      <p class="text-base text-gray-400 text-center">&copy; 2025 yieldsApp. Empowering Philippine Agriculture.</p>
